      ...
      <div className=" bg-[url(https://imgur.com/kVx9fUa)]  bg-no-repeat rounded-md bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-50 border border-gray-100 ">
        <div className="p-12 max-w-1.5">
          ...
          <div className="flex flex-row justify-center items-center">
            <button className="relative block group items-center mr-1" onClick={CreateStreamTarget}>
              <span className="absolute inset-0 bg-indigo-500 rounded-lg"></span>
              <div className="transition bg-indigo-500 relative border-2 rounded-lg group-hover:-translate-x-2 group-hover:-translate-y-2">
              <div className="p-2">
            ...
            <button className="relative block group items-center mr-1" onClick={clearForm}>
                <span className="absolute inset-0 bg-indigo-500 rounded-lg"></span>
                <div className="transition bg-indigo relative border-2 rounded-lg group-hover:-translate-x-2 group-hover:-translate-y-2">
                  <div className="p-2">
